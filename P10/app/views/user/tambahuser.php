        ...
        <div class="admin-main">
            ...
            <main class="dashboard-content">
                ...
                <div class="panel-body p-4">
                    <form action="/Faiz1TIA/P10/index.php?aksi=simpanUser" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_lengkap" class="form-control" placeholder="Masukkan Nama Lengkap User"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Jabatan</label>
                            <input type="text" name="jabatan" class="form-control" placeholder="Masukkan Jabatan User"
                            required>
                        </div>
                        <div class="mb-3">
