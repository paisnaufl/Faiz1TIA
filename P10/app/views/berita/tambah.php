    ...
    <div class="admin-shell">
        ...
        <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
            ...
            <nav class="sidebar-nav">
                <a class="nav-link active" href="/Faiz1TIA/P10/index.php?aksi=dashboard" aria-current="page">
        ...
        <div class="admin-main">
            ...
            <main class="dashboard-content">
                ...
                <div class="panel-body p-4">
                    <form action="/Faiz1TIA/P10/index.php?aksi=simpan" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="/Faiz1TIA/P10/index.php?aksi=dashboard" class="btn btn-secondary">
